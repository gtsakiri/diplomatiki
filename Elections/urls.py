...
path('ajax/load-sindiasmoi/<int:eklid>/', views.load_sindiasmoi, name='ajax_load_sindiasmoi'),
...
path('ajax/update/psifoi/', views.update_psifoi, name='ajax_update_psifoi'),
...
path('psifodeltiaedit/<int:eklid>/<int:sindid>/<int:kenid>/', views.psifodeltia_edit, name='psifodeltia_edit'),
path('psifodeltiaadd/<int:eklid>/', views.psifodeltia_add, name='psifodeltia_add'),
path('psifodeltiadelete/<int:eklid>/<int:sindid>/<int:kenid>/', views.psifodeltia_delete, name='psifodeltia_delete'),
...
path('psifodeltiasindkoin/<int:eklid>/<int:eidos>/<int:sunday>/', views.psifodeltiasindkoin, name='psifodeltiasind_koin'),
...
path('export/koin/<int:eklid>/<int:selected_order>/<int:eidoskoinotitas>', views.export_psifoikoin_xls, name='export_psifoikoin_xls'),
