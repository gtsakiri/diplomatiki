...
#ΠΟΣΟΣΤΑ ΣΥΝΔΥΑΣΜΩΝ ΣΕ ΟΛΟ ΤΟ ΔΗΜΟ
    ...
    all_pososta = EklSumpsifodeltiasindVw.objects.filter(eklid=eklid).values_list('shortdescr', 'posostosindiasmou','posostokatametrimenwnkentrwn', 'photo').order_by('-posostosindiasmou')
